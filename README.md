...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/txt2image
```

A live public deployment of this template is available at [https://txt2image.templates.workers.dev](https://txt2image.templates.workers.dev)
